...
function createGraphHelper( graph, nodeSize = 1, nodeColor = 0x4e84c4, edgeColor = (0xffffff-0x4e84c4) ) {

    const group = new THREE.Group();

    // nodes

    const nodeMaterial = new THREE.MeshBasicMaterial( { color: nodeColor,depthTest: false } );
    ...
    const edgesMaterial = new THREE.LineBasicMaterial( { color: edgeColor,linewidth:5,depthTest:false } );
